...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-ecf34eaa.js",
      css: [assets + "/_app/assets/start-61d1577b.css"],
      js: [assets + "/_app/start-ecf34eaa.js", assets + "/_app/chunks/vendor-3230972b.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "email.svg", "size": 943, "type": "image/svg+xml" }, { "file": "favicon.png", "size": 1571, "type": "image/png" }, { "file": "instagram.svg", "size": 1621, "type": "image/svg+xml" }, { "file": "keyboard.svg", "size": 6428, "type": "image/svg+xml" }, { "file": "keyboard_1.jpg", "size": 119552, "type": "image/jpeg" }, { "file": "robots.txt", "size": 67, "type": "text/plain" }, { "file": "svelte-welcome.png", "size": 360807, "type": "image/png" }, { "file": "svelte-welcome.webp", "size": 115470, "type": "image/webp" }],
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-f51688e3.js", "css": ["assets/pages/__layout.svelte-f5dbf198.css"], "js": ["pages/__layout.svelte-f51688e3.js", "chunks/vendor-3230972b.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-f82d2c5c.js", "css": [], "js": ["error.svelte-f82d2c5c.js", "chunks/vendor-3230972b.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-994e4392.js", "css": ["assets/pages/index.svelte-1ae03b51.css"], "js": ["pages/index.svelte-994e4392.js", "chunks/vendor-3230972b.js"], "styles": [] }, "src/routes/about.svelte": { "entry": "pages/about.svelte-c3ccd46c.js", "css": ["assets/pages/about.svelte-d9570fcb.css"], "js": ["pages/about.svelte-c3ccd46c.js", "chunks/vendor-3230972b.js"], "styles": [] }, "src/routes/todos/index.svelte": { "entry": "pages/todos/index.svelte-d7bb61ea.js", "css": ["assets/pages/todos/index.svelte-784042c1.css"], "js": ["pages/todos/index.svelte-d7bb61ea.js", "chunks/vendor-3230972b.js"], "styles": [] } };
...
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<header class="${"svelte-1fbtq54"}"><div class="${"corner svelte-1fbtq54"}"><a href="${"/"}" class="${"svelte-1fbtq54"}">MKC
		</a></div>

	<nav class="${"svelte-1fbtq54"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-1fbtq54"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-1fbtq54"}"></path></svg>
		<ul class="${"svelte-1fbtq54"}"><li class="${["svelte-1fbtq54", $page.path === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-1fbtq54"}">MasKeyCustoms</a></li>
			<li class="${["svelte-1fbtq54", $page.path === "/about" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/about"}" class="${"svelte-1fbtq54"}">About</a></li>
			</ul>
		<svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-1fbtq54"}"><path d="${"M0,0 L0,3 C0.5,3 0.5,3 1,2 L2,0 Z"}" class="${"svelte-1fbtq54"}"></path></svg></nav>

	<div class="${"corner svelte-1fbtq54"}"></div>
</header>`;
});
var css$4 = {
  code: "main.svelte-1fpkfg6.svelte-1fpkfg6{flex:1;display:flex;flex-direction:column;padding:1rem;width:100%;max-width:1024px;margin:0 auto;box-sizing:border-box}footer.svelte-1fpkfg6.svelte-1fpkfg6{display:flex;flex-direction:column;justify-content:center;align-items:center;padding:40px;background:linear-gradient(\n			180deg,\n			rgba(236, 247, 145, 0.5) 1.45%,\n			#446a87 15.35%\n		)}footer.svelte-1fpkfg6 a.svelte-1fpkfg6{font-weight:lighter}footer.svelte-1fpkfg6 p.svelte-1fpkfg6{color:antiquewhite }footer.svelte-1fpkfg6 img.svelte-1fpkfg6{width:1rem}@media(max-width: 480px){footer.svelte-1fpkfg6.svelte-1fpkfg6{padding:40px 0}}",
  map: `{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script>\\n\\timport Header from '$lib/header/Header.svelte';\\n\\timport '../app.css';\\n<\/script>\\n\\n<Header />\\n\\n<main>\\n\\t<slot />\\n</main>\\n\\n<footer>\\n\\t<p>\\n\\t\\t<img src=\\"email.svg\\" alt=\\"Email\\"/> &nbsp;&nbsp;<a target=\\"_blank\\" href=\\"mailto:maskeycus@gmail.com\\" >maskeycus@gmail.com</a> \\n<br /> <img src=\\"instagram.svg\\" alt=\\"Instagram\\"/> &nbsp;&nbsp;<a target=\\"_blank\\" href=\\"https://www.instagram.com/maskey_customs/\\" >@maskey.customs</a></p>\\n</footer>\\n\\n\\n<style>\\n\\tmain {\\n\\t\\tflex: 1;\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tpadding: 1rem;\\n\\t\\twidth: 100%;\\n\\t\\tmax-width: 1024px;\\n\\t\\tmargin: 0 auto;\\n\\t\\tbox-sizing: border-box;\\n\\t}\\n\\n\\tfooter {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tjustify-content: center;\\n\\t\\talign-items: center;\\n\\t\\tpadding: 40px;\\n\\t\\tbackground: linear-gradient(\\n\\t\\t\\t180deg,\\n\\t\\t\\trgba(236, 247, 145, 0.5) 1.45%,\\n\\t\\t\\t#446a87 15.35%\\n\\t\\t);\\n\\t}\\n\\n\\tfooter a {\\n\\t\\tfont-weight: lighter;\\n\\t}\\n\\n\\tfooter p {\\n\\t\\tcolor: antiquewhite ;\\n\\t}\\n\\n\\tfooter img {\\n\\t\\twidth: 1rem;\\n\\t}\\n\\n\\t@media (max-width: 480px) {\\n\\t\\tfooter {\\n\\t\\t\\tpadding: 40px 0;\\n\\t\\t}\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAmBC,IAAI,8BAAC,CAAC,AACL,IAAI,CAAE,CAAC,CACP,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,OAAO,CAAE,IAAI,CACb,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,MAAM,CACjB,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,UAAU,CAAE,UAAU,AACvB,CAAC,AAED,MAAM,8BAAC,CAAC,AACP,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,IAAI,CACb,UAAU,CAAE;GACX,MAAM,CAAC;GACP,KAAK,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,KAAK,CAAC;GAC/B,OAAO,CAAC,MAAM;GACd,AACF,CAAC,AAED,qBAAM,CAAC,CAAC,eAAC,CAAC,AACT,WAAW,CAAE,OAAO,AACrB,CAAC,AAED,qBAAM,CAAC,CAAC,eAAC,CAAC,AACT,KAAK,CAAE,YAAY,CAAC,AACrB,CAAC,AAED,qBAAM,CAAC,GAAG,eAAC,CAAC,AACX,KAAK,CAAE,IAAI,AACZ,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAC1B,MAAM,8BAAC,CAAC,AACP,OAAO,CAAE,IAAI,CAAC,CAAC,AAChB,CAAC,AACF,CAAC"}`
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$4);
  return `${validate_component(Header, "Header").$$render($$result, {}, {}, {})}

<main class="${"svelte-1fpkfg6"}">${slots.default ? slots.default({}) : ``}</main>

<footer class="${"svelte-1fpkfg6"}"><p class="${"svelte-1fpkfg6"}"><img src="${"email.svg"}" alt="${"Email"}" class="${"svelte-1fpkfg6"}"> \xA0\xA0<a target="${"_blank"}" href="${"mailto:maskeycus@gmail.com"}" class="${"svelte-1fpkfg6"}">maskeycus@gmail.com</a> 
<br> <img src="${"instagram.svg"}" alt="${"Instagram"}" class="${"svelte-1fpkfg6"}"> \xA0\xA0<a target="${"_blank"}" href="${"https://www.instagram.com/maskey_customs/"}" class="${"svelte-1fpkfg6"}">@maskey.customs</a></p>
</footer>`;
});
